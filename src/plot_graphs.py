...
def plot_nozgapopen_durations_dist(cwd, sn, nozgap_event_durations):
    ...
    plt.savefig(f'{cwd}/graphs/{sn}/nozgapopen_durations_dist_plot.png')  # Save plot
    plt.close()
...
def plot_corr_matrix(cwd, sn, df):
    ...
    plt.savefig(f'{cwd}/graphs/{sn}/correlation_matrix.png')  # Save plot
    plt.close()
...
def plot_total_nozgapopen_duration_per_bin(cwd, sn, nozgap_event_durations):
    ...
    plt.savefig(f'{cwd}/graphs/{sn}/total_nozgapopen_durations_plot.png')  # Save plot
    plt.close()
...
def plot_fuel_rate_dist(cwd, sn, dfs):
    ...
    plt.savefig(f'{cwd}/graphs/{sn}/fuel_rate_dist_plot.png')  # Save plot
    plt.close()
...
def plot_fan_speed_dist(cwd, sn, dfs):
    ...
    plt.ylabel('Frequency')
    plt.legend()
    plt.savefig(f'{cwd}/graphs/{sn}/fan_speed_dist_plot.png')  # Save plot
    plt.close()
...
def plot_engine_speed_dist(cwd, sn, dfs):
    ...
    plt.ylabel('Frequency')
    plt.legend()
    plt.savefig(f'{cwd}/graphs/{sn}/engine_speed_dist_plot.png')  # Save plot
    plt.close()
